...
DROP TABLE IF EXISTS `odl_auth_access`;

CREATE TABLE `odl_auth_access` (
...
LOCK TABLES `odl_auth_access` WRITE;
/*!40000 ALTER TABLE `odl_auth_access` DISABLE KEYS */;

INSERT INTO `odl_auth_access` (`role_id`, `rule_id`)
VALUES
	(2,3),
	(1,2),
	(2,1),
...
/*!40000 ALTER TABLE `odl_auth_access` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table odl_auth_rule
# ------------------------------------------------------------

DROP TABLE IF EXISTS `odl_auth_rule`;

CREATE TABLE `odl_auth_rule` (
...
LOCK TABLES `odl_auth_rule` WRITE;
/*!40000 ALTER TABLE `odl_auth_rule` DISABLE KEYS */;

INSERT INTO `odl_auth_rule` (`id`, `title`, `rule_val`, `pid`, `update_time`, `delete_time`)
VALUES
...
/*!40000 ALTER TABLE `odl_auth_rule` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table odl_log_record
# ------------------------------------------------------------

DROP TABLE IF EXISTS `odl_log_record`;

CREATE TABLE `odl_log_record` (
...
LOCK TABLES `odl_log_record` WRITE;
/*!40000 ALTER TABLE `odl_log_record` DISABLE KEYS */;

INSERT INTO `odl_log_record` (`id`, `user_id`, `ip`, `os`, `browser`, `remark`, `create_time`)
VALUES
...
/*!40000 ALTER TABLE `odl_log_record` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table odl_role
# ------------------------------------------------------------

DROP TABLE IF EXISTS `odl_role`;

CREATE TABLE `odl_role` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `odl_role` WRITE;
/*!40000 ALTER TABLE `odl_role` DISABLE KEYS */;

INSERT INTO `odl_role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`)
VALUES
	(1,'超级管理员1',0,1,'网站最高管理员权限！',1329633709,1329633709),
	(2,'测试角色',NULL,0,'测试角色',1482389092,0);

/*!40000 ALTER TABLE `odl_role` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table odl_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `odl_user`;

CREATE TABLE `odl_user` (
...
LOCK TABLES `odl_user` WRITE;
/*!40000 ALTER TABLE `odl_user` DISABLE KEYS */;

INSERT INTO `odl_user` (`id`, `username`, `mobile`, `password`, `status`, `create_time`, `administrator`, `role_id`, `update_time`, `delete_time`)
VALUES
...
/*!40000 ALTER TABLE `odl_user` ENABLE KEYS */;
UNLOCK TABLES;
